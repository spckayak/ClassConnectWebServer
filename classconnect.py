...
def dashboard():
    ...
    result = cur.fetchone()
    db.close()
    classlist= Markup('<div class="info-box-content"><span class="info-box-text"><a href="task.html">CIT480</a></span><span class="info-box-number">16586-Fall 2017</span><span class="info-box-number">Attendance today</span></div>')
