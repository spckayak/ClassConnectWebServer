...
def dashboard():
    ...
    for row in result:
		...
		insertBox = "<div class=\"info-box-content\"><span class=\"info-box-text\"><a href=\"task.html\">%s</a></span><span class=\"info-box-number\">%s - %s %s</span></div>" % (className,classSect,classSeme,classYear)
