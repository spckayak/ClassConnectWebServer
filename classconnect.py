...
def dashboard():
    ...
    for row in result:
		...
		insertBox = "<hr><div class=\"col-md-3 col-sm-6 col-xs-12\"><div class=\"info-box-content\"><span class=\"info-box-text\"><a href=\"task.html\">%s</a></span><span class=\"info-box-number\">%s - %s %s</span><span class=\"info-box-number\">Attendance today</span></div></div></div>" % (className,classSect,classSeme,classYear)
